    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <span x="110" y="220" fill="red" fontSize="30" className="cart_quantity_count">{cartItems.length}</span>
            ...
            <div key={index}>
                ...
                <div className="product-list">
                    ...
                    <div className="product-card" key={plantIndex}>
                        ...
                        {/* <button  className="product-button" onClick={() => handleAddToCart(plant)} disabled={addedToCart[plant.name] ? "disabled" : ""}>Add to Cart</button> */}
